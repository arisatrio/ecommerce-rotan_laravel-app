...
@section('content')
    <x-_admin.page-content>
        ...
        @slot('breadcrumb')
            ...
            <li class="breadcrumb-item active">Kurir Ekspedisi</li>
        @endslot

        @slot('cardTitle')
            Daftar Kurir Ekspedisi
        @endslot
        ...
        <div class="card-body">
            ...
            <div class="row mb-2">
                <div class="col">
                    <a href="{{ route('admin.shipping.create') }}" class="btn btn-success float-right"> <i class="fas fa-plus"></i> Tambah Kurir Ekspedisi</a>
                </div>
            </div>
