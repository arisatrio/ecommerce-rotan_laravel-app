                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0)">Proses Order</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="address1" required rows="10"></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="order-details">
                                            ...
                                            <li class="shipping">
                                                ...
                                                @if(count(Helper::shipping())>0 && Helper::cartCount()>0)
                                                    <select name="shipping" class="nice-select">
                                                        ...
                                                        <option value="{{$shipping->id}}" class="shippingOption" data-price="{{$shipping->price}}">{{$shipping->destination}}: {{$shipping->price}}</option>
                                                        @endforeach
                                                    </select>
                                                @else 
                                                    <span>Free</span>
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            <form-group>
                                                <input name="payment_method"  type="radio" value="cod" checked> <label> Transfer</label><br>
                                            </form-group>   
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-widget payement">
                                    <div class="content">
                                        <p>BCA 3030231132 a/n Rotan Shop </p>
                                    </div>
                                </div>
